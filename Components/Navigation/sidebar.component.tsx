...
import { BiBarChartAlt, BiCalendar, BiChevronRight, BiFolder, BiLayout, BiReceipt, BiUser, BiWallet } from 'react-icons/bi';
...
const menuItems = [
  ...
  { id: 'transactions', label: 'Transactions', icon: BiReceipt, badge: 'New' },
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200/50 dark:border-gray-700/50">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold gradient-text">FinanceSaaS</h1>
